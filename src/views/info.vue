  ...
  <article>
    ...
    <h1 class="t_nav">
      ...
      <a
        ...
        v-if="blogData.type"
        @click="goToSortList(blogData.type)"
        class="n2"
      >{{blogData.type ? blogData.typeName:""}}</a>
    </h1>
    <div class="infosbox">
      <div class="newsview">
        ...
        <div class="tags">
          <a
            v-if="blogData.signListName"
            v-for="item in blogData.signListName"
            :key="item"
          >{{item}}</a>
        </div>
        <div class="news_about">
          <strong>版权</strong>
          本文为JFTM博客原创内容，若需要转载，请注明出处
        </div>
        <div
